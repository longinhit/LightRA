    ...
    for dataset in args.datasets:
        ...
        for experiment in args.experiments: 
            for shot in args.shots:
                folders.append(f'{args.directory}/{experiment}/{dataset}/shots_{shot}/{args.trainer}/')
        for folder in folders:
            results = parse_function(
                metric, directory=folder, args=args, end_signal=end_signal
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--datasets", type=str, nargs='+', help="List of dataset name" )
    parser.add_argument("--experiments", type=str, nargs='+', help="List of experiment" )
    parser.add_argument("--shots", type=int, nargs='+', help="List of shot" )
    parser.add_argument(
